...
class QuotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post quotations_url, params: { quotation: { description: @quotation.description, duration: @quotation.duration, price: @quotation.price, quotationNumber: @quotation.quotationNumber } }
    end
  ...
  test "should update quotation" do
    patch quotation_url(@quotation), params: { quotation: { description: @quotation.description, duration: @quotation.duration, price: @quotation.price, quotationNumber: @quotation.quotationNumber } }
