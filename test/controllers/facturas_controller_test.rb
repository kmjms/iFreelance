...
class FacturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post facturas_url, params: { factura: { descripcion: @factura.descripcion, fecha: @factura.fecha, id: @factura.id, total: @factura.total } }
    end
  ...
  test "should update factura" do
    patch factura_url(@factura), params: { factura: { descripcion: @factura.descripcion, fecha: @factura.fecha, id: @factura.id, total: @factura.total } }
