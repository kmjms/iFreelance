...
class StateProjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state_project" do
    assert_difference('StateProject.count') do
      post state_projects_url, params: { state_project: { description: @state_project.description, name_state: @state_project.name_state } }
    end
  ...
  test "should update state_project" do
    patch state_project_url(@state_project), params: { state_project: { description: @state_project.description, name_state: @state_project.name_state } }
